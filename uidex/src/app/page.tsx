				...
				<ScrollAnimation className='flex flex-col justify-center items-center gap-8  py-16 px-4 text-center max-w-screen-xl mx-auto'>
					<div className='flex flex-col gap-4 w-full max-w-3xl'>
						<h1 className='font-semibold text-3xl sm:text-4xl lg:text-6xl'>
							Solução para <span className='text-primary'>Agência</span>{' '}
							digital
						</h1>
						<p className='text-muted text-base sm:text-lg max-w-2xl mx-auto'>
							Impulsione sua presença online com estratégias
							personalizadas, design moderno e tecnologia de ponta.
							Transformamos ideias em experiências digitais que conectam
							marcas e pessoas.
						</p>
					</div>
						...
						<div className='flex lg:flex-row flex-col gap-8 items-center justify-between w-full lg:p-6 p-0'>
							<div className='w-full flex justify-start p-2'>
								<p className='text-muted/70 text-center'>
									Combinamos criatividade, tecnologia e estratégia para
									entregar soluções digitais que geram resultados reais.
									Nossa equipe é especializada em transformar desafios em
					...
					<ScrollAnimation className=' flex flex-col gap-10 items-center text-center'>
						<div className='space-y-4'>
							...
							<p className='max-w-2xl mx-auto text-muted text-base md:text-lg'>
								...
								inovar, acelerar resultados e fortalecer sua presença
								online. Juntos, construímos experiências que conectam
								marcas e pessoas.
							</p>
						</div>
				...
				<div>
					<ScrollAnimation className='flex items-center justify-center flex-col p-10 gap-8'>
						<div className='flex flex-col items-center gap-8'>
							<h3 className='text-4xl lg:text-5xl max-w-3xl text-center font-semibold'>
								Oferecemos uma{' '}
								<span className='text-primary'>ampla variedade</span> de
								serviços digitais
							</h3>
							<p className='max-w-2xl text-center text-base md:text-lg'>
								Do design de interfaces ao desenvolvimento completo de
								produtos digitais, entregamos soluções personalizadas para
								fortalecer sua marca e gerar resultados reais.
							</p>
						</div>
			...
			<section id='contact'>
				<div className='bg-primary text-primary-foreground'>
					<ScrollAnimation className='py-16 px-4 container mx-auto text-center flex flex-col items-center gap-6'>
						<h5 className='text-4xl font-bold max-w-2xl'>
							Pronto para levar seu negócio ao próximo nível?
						</h5>

						<p className='max-w-xl text-lg opacity-90'>
							Fale com a nossa equipe e descubra como podemos transformar
							suas ideias em soluções digitais reais e escaláveis.
						</p>
